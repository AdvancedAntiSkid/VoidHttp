...
public class CustomPrintStream extends PrintStream {
    ...
    /**
     * The color of the messages shown by the print stream.
     */
     ...
     */
    public CustomPrintStream(String prefix, String color) {
        super(System.out);
        this.prefix = prefix;
        this.color = color;
    }
    ...
    public void println(String x) {
        ...
        super.printf(color + "[%s:%s:%s] [%s/%s]: %s%n", hours, minutes, seconds, Thread.currentThread().getName(), prefix, x);
    }
